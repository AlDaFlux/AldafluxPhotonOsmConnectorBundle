...
class Configuration implements ConfigurationInterface
{
  ...
  const KEY_TIMEOUT = 'timeout';
    ...
    const KEY_API_HOST_REVERSE = 'reverse';
    const KEY_LANG = 'lang';

    const API_HOST_DEFAULT = 'https://photon.komoot.io/api/';
    const API_HOST_REVERSE = 'https://photon.komoot.io/reverse';
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ->children()
                ->enumNode(self::KEY_LANG)->values(['en', 'de', 'fr', 'es', 'ru'])->defaultValue('fr')->end()
                ->scalarNode(self::KEY_API_HOST)->defaultValue(self::API_HOST_DEFAULT)->end()
                ->scalarNode(self::KEY_API_HOST_REVERSE)->defaultValue(self::API_HOST_REVERSE)->end()
